...
// Component to display speed math statistics in a grid layout
...
const SpeedMathStats = ({ score, problemsSolved, streak, bestStreak }: SpeedMathStatsProps): JSX.Element => {
  // Render the speed math statistics component
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
      <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl p-4 text-center shadow-lg">
        <div className="text-gray-200 text-sm font-medium mb-1">SCORE</div>
