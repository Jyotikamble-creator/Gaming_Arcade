...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-40 h-dvh w-72 overflow-y-auto bg-gray-900/90 backdrop-blur-xl border-r border-gray-700/50 transform transition-transform duration-300 md:static md:z-auto md:h-auto md:w-64 md:translate-x-0 ${isMobileOpen ? 'translate-x-0' : '-translate-x-full'
          }`}
      >
        <div className="p-6">
