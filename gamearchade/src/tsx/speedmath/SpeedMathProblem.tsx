...
interface SpeedMathProblemProps {
  problem: {
    question: string;
    answer: number;
    operation: string;
...
const SpeedMathProblem = ({
  ...
  onKeyPress,
  feedback
}: SpeedMathProblemProps): JSX.Element => {
    ...
    <div className="bg-gray-800/90 backdrop-blur-sm rounded-2xl p-8 border border-purple-500/30 shadow-2xl">
      ...
      <div className="flex gap-4">
        ...
        <button
          ...
          className="flex-1 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 disabled:from-gray-600 disabled:to-gray-600 disabled:cursor-not-allowed text-white font-bold py-3 px-6 rounded-xl transition-all duration-200 shadow-lg"
        >
          Submit ✓
        </button>
      </div>
