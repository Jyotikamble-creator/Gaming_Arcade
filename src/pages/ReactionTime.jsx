...
export default function ReactionTime() {
  ...
  const getPerformanceRating = (avg) => {
    if (avg < 250) return { text: '≡ƒÅå Lightning Fast!', color: 'text-yellow-300' };
    if (avg < 300) return { text: 'ΓÜí Excellent!', color: 'text-green-300' };
    if (avg < 350) return { text: '≡ƒæì Good!', color: 'text-blue-300' };
    if (avg < 400) return { text: '≡ƒæî Average', color: 'text-purple-300' };
    return { text: '≡ƒÆ¬ Keep Practicing!', color: 'text-orange-300' };
  };
    ...
    <div className="min-h-screen text-light-text relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-5xl font-bold text-white mb-2">ΓÜí Reaction Time Tester</h1>
