...
export default function WordBuilderCompletedModal({
  ...
  const completionPercent = Math.round((wordsFound.length / totalWords) * 100);

  // Performance rating based on completion percentage
  const getRating = () => {
    if (completionPercent === 100) return { stars: 5, label: 'Perfect!', color: '#fbbf24' };
    if (completionPercent >= 80) return { stars: 4, label: 'Excellent!', color: '#a78bfa' };
    if (completionPercent >= 60) return { stars: 3, label: 'Great!', color: '#60a5fa' };
    if (completionPercent >= 40) return { stars: 2, label: 'Good!', color: '#34d399' };
      ...
      >
        ...
        <div className="stats-grid">
          ...
          <div className="stat-item">
            ...
            <div className="stat-name">Words Found</div>
            <div className="stat-number">{wordsFound.length}/{totalWords}</div>
          </div>
          ...
          <div className="stat-item">
            ...
            <div className="stat-name">Hints Used</div>
        ...
        {missedWords.length > 0 && (
          <div className="words-summary">
            <h3 className="summary-title">Missed Words:</h3>
            <div className="missed-words-list">
              {missedWords.map((word, index) => (
                <span key={index} className="missed-word">{word}</span>
              ))}
            </div>
          </div>
        )}
